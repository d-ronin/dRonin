...
import org.dronin.androidgcs.telemetry.tasks.LoggingTask;
...
public class TelemetryService extends Service {
	...
	// Intent category
	public final static String INTENT_CATEGORY_GCS        = "org.dronin.intent.category.GCS";

	// Intent actions
	public final static String INTENT_CHANNEL_OPENED      = "org.dronin.intent.action.CHANNEL_OPENED";
	public final static String INTENT_ACTION_CONNECTED    = "org.dronin.intent.action.CONNECTED";
	public final static String INTENT_ACTION_DISCONNECTED = "org.dronin.intent.action.DISCONNECTED";
	...
	public boolean loadUavobjects(String jar, UAVObjectManager objMngr) {
		...
		try {
			Class<?> initClass = loader.loadClass("org.dronin.uavtalk.uavobjects.UAVObjectsInitialize");
