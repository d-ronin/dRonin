...
namespace uploader
{
typedef enum { DISCONNECTED, BOOTING, HALTING, RESCUING, BL_SITTING, CONNECTED_TO_TELEMETRY, UPLOADING_FW, UPLOADING_DESC, DOWNLOADING_PARTITION, UPLOADING_PARTITION} UploaderStatus;
}
struct deviceInfo
{
