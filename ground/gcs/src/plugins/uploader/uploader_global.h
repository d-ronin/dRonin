...
namespace uploader
{
typedef enum { DISCONNECTED, ENTERING_LOADER, BL_SITTING, CONNECTED_TO_TELEMETRY, UPLOADING_FW, UPLOADING_DESC, DOWNLOADING_PARTITION, UPLOADING_PARTITION } UploaderStatus;
}
struct deviceInfo
{
