...
/**
 * @brief The ModelMapProxy class maps from the @ref FlightDataModel to the
 * OPMap
...
class ModelMapProxy : public QObject
{
    ...
    Q_OBJECT
public:
    explicit ModelMapProxy(QObject *parent, TLMapWidget *map,
...
private:
    ...
    void createOverlay(WayPointItem *from, WayPointItem *to, overlayType type,
                       QColor color, double radius);
    void createOverlay(WayPointItem *from, HomeItem *to,
