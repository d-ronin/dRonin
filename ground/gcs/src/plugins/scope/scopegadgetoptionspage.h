...
public:
    ...
    explicit ScopeGadgetOptionsPage(ScopeGadgetConfiguration *config,
                                    QObject *parent = 0);
...
private:
    ...
    void addPlot2dCurveConfig(QString uavObject, QString uavField, int scale,
                              unsigned int mean, QString mathFunction,
                              QVariant varColor);
    void setPlot2dCurveProperties(QListWidgetItem *listWidgetItem,
