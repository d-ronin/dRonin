...
signals:
    ...
    void configurationNameChanged(IUAVGadgetConfiguration *config, QString oldName,
                                  QString newName);
...
private:
    ...
    int indexForConfig(QList<IUAVGadgetConfiguration *> configurations, QString classId,
                       QString configName);
