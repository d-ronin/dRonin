...
public:
    ...
    static void enableComboBoxes(QWidget *owner, QString boxName, int boxCount,
                                 bool enable);
    ...
    void setThrottleCurve(UAVDataObject *mixer,
                          MixerSettings::Mixer1VectorElem curveType,
                          QList<double> curve);
    void getThrottleCurve(UAVDataObject *mixer,
                          MixerSettings::Mixer1VectorElem curveType,
                          QList<double> *curve);
...
protected:
    void setLabelText(QWidget *owner, const QString &boxName,
