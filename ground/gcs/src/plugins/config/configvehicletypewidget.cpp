 ...
 * @author     E. Lafargue, K. Sebesta & The OpenPilot Team, http://www.openpilot.org Copyright (C)
 *2012
...
/**
 * @brief ConfigVehicleTypeWidget::doSetupAirframeUI Reads combobox value and then calls airframe UI
 * setup method
 * @param comboboxIndex
 */
