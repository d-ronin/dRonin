...
template <typename MatrixBase> bool hasNaN(const MatrixBase &expr);

template <typename MatrixBase> bool hasInf(const MatrixBase &expr);
...
template <typename MatrixBase> bool isReal(const MatrixBase &exp)
{
