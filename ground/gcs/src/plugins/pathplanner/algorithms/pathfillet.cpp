...
/**
 * @brief addNonCircleToSwitchingLoci In the case of pure circles, the given waypoint is for a
 * circle center,
...
/**
 * @brief angle_between_2d_vectors Using simple vector calculus, calculate the angle between two 2D
 * vectors
 * @param a
 * @param b
