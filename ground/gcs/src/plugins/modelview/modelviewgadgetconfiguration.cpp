...
ModelViewGadgetConfiguration::ModelViewGadgetConfiguration(QString classId, QSettings *qSettings, QObject *parent) :
    ...
    m_acFilename("../share/taulabs/models/planes/Easystar/EasyStar.3ds"),
    m_bgFilename(""),
    m_enableVbo(false)
{
    ...
    if (qSettings != 0) {
        ...
        m_acFilename = Utils::PathUtils::getInstance()->InsertDataPath(modelFile);
        m_bgFilename = Utils::PathUtils::getInstance()->InsertDataPath(bgFile);
    }
}
...
{
    qSettings->setValue("acFilename", Utils::PathUtils::getInstance()->RemoveDataPath(m_acFilename));
    qSettings->setValue("bgFilename", Utils::PathUtils::getInstance()->RemoveDataPath(m_bgFilename));
