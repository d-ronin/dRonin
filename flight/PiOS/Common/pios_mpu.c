...
/**
 * Supported internal magnetometers TODO: get rid of this? they are the same?
 */
enum pios_mpu_mag {
	PIOS_AK89XX,     /**< AK89XX, contained in MPU-9x50 */
	PIOS_MPU_MAG_NUM /**< Number of elements */
};

static const uint8_t pios_mpu_mag_whoami[PIOS_MPU_MAG_NUM] = {
	[PIOS_AK89XX] = 0x48,
};
...
#ifdef PIOS_INCLUDE_MPU_MAG
	enum pios_mpu_mag mag_type;          /**< The internal magnetometer type */
	bool use_mag;
