...
enum pios_icm2060x_gyro_filter {
	PIOS_ICM2060X_GYRO_LOWPASS_250_HZ  = 0x00, // 8KHz sample mode
	PIOS_ICM2060X_GYRO_LOWPASS_176_HZ  = 0x01,
	PIOS_ICM2060X_GYRO_LOWPASS_92_HZ   = 0x02,
	PIOS_ICM2060X_GYRO_LOWPASS_41_HZ   = 0x03,
	PIOS_ICM2060X_GYRO_LOWPASS_20_HZ   = 0x04,
	PIOS_ICM2060X_GYRO_LOWPASS_10_HZ   = 0x05,
	PIOS_ICM2060X_GYRO_LOWPASS_5_HZ    = 0x06,
	PIOS_ICM2060X_GYRO_LOWPASS_3281_HZ = 0x07 // 8KHz sample mode
};
...
enum pios_icm2060x_accel_filter {
	PIOS_ICM2060X_ACCEL_LOWPASS_218_HZ = 0x00, // 0x00 and 0x01 are identical.
	PIOS_ICM2060X_ACCEL_LOWPASS_99_HZ  = 0x02,
	PIOS_ICM2060X_ACCEL_LOWPASS_45_HZ  = 0x03,
	PIOS_ICM2060X_ACCEL_LOWPASS_21_HZ  = 0x04,
	PIOS_ICM2060X_ACCEL_LOWPASS_10_HZ  = 0x05,
	PIOS_ICM2060X_ACCEL_LOWPASS_5_HZ   = 0x06,
	PIOS_ICM2060X_ACCEL_LOWPASS_420_HZ = 0x07
};
