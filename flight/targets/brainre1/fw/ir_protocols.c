...
*****************************************************************************/
uint16_t crc_ilap_trackmate(uint16_t crc, const uint8_t *data, uint8_t data_len)
{
	uint32_t i;
	uint32_t bit;
	uint8_t c;
...
void ir_generate_ilap_packet(uint32_t ilap_id, uint8_t * data, uint8_t data_len)
{
	...
	uint16_t crc = crc_ilap_trackmate(0x00, crc_data, 4);
...
void ir_generate_trackmate_packet(uint16_t trackmate_id, uint8_t * data, uint8_t data_len)
{
	...
	uint16_t crc = crc_ilap_trackmate(0xFB1A, crc_data, 2);
