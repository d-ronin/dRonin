...
void PIOS_Board_Init(void) {
...
#else
	{
		...
		HwMotolabMagnetometerGet(&Magnetometer);

		if (Magnetometer == HWMOTOLAB_MAGNETOMETER_INTERNAL)
		...
		HwMotolabMPU9150DLPFGet(&hw_mpu9150_dlpf);
		enum pios_mpu60x0_filter mpu9150_dlpf = \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
		    (hw_mpu9150_dlpf == HWMOTOLAB_MPU9150DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
		    pios_mpu9150_cfg.default_filter;
		PIOS_MPU9150_SetLPF(mpu9150_dlpf);

		uint8_t hw_mpu9150_samplerate;
		HwMotolabMPU9150RateGet(&hw_mpu9150_samplerate);
		uint16_t mpu9150_samplerate = \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_200) ? 200 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_333) ? 333 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_500) ? 500 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_666) ? 666 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_1000) ? 1000 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_2000) ? 2000 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_4000) ? 4000 : \
		    (hw_mpu9150_samplerate == HWMOTOLAB_MPU9150RATE_8000) ? 8000 : \
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		if (Magnetometer == HWMOTOLAB_MAGNETOMETER_EXTERNALI2CFLEXIPORT)
		{
			// setup sensor orientation
			uint8_t ExtMagOrientation;
			HwMotolabExtMagOrientationGet(&ExtMagOrientation);
			...
			enum pios_hmc5883_orientation hmc5883_orientation = \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_TOP0DEGCW)      ? PIOS_HMC5883_TOP_0DEG      : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_TOP90DEGCW)     ? PIOS_HMC5883_TOP_90DEG     : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_TOP180DEGCW)    ? PIOS_HMC5883_TOP_180DEG    : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_TOP270DEGCW)    ? PIOS_HMC5883_TOP_270DEG    : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_BOTTOM0DEGCW)   ? PIOS_HMC5883_BOTTOM_0DEG   : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_BOTTOM90DEGCW)  ? PIOS_HMC5883_BOTTOM_90DEG  : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
				(ExtMagOrientation == HWMOTOLAB_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
